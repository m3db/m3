...
# TODO(rartoul): Note that we want to set the bufferPast/bufferFuture values for the
# downsampler to a reasonably large value to ensure this test is acting correctly.
