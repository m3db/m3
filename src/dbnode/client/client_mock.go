...
import (
	...
	middleware "github.com/m3db/m3/src/dbnode/client/circuitbreaker/middleware"
	encoding "github.com/m3db/m3/src/dbnode/encoding"
	rpc "github.com/m3db/m3/src/dbnode/generated/thrift/rpc"
	namespace "github.com/m3db/m3/src/dbnode/namespace"
	runtime "github.com/m3db/m3/src/dbnode/runtime"
	block "github.com/m3db/m3/src/dbnode/storage/block"
	result "github.com/m3db/m3/src/dbnode/storage/bootstrap/result"
	index "github.com/m3db/m3/src/dbnode/storage/index"
	topology "github.com/m3db/m3/src/dbnode/topology"
	clock "github.com/m3db/m3/src/x/clock"
	context0 "github.com/m3db/m3/src/x/context"
	ident "github.com/m3db/m3/src/x/ident"
	instrument "github.com/m3db/m3/src/x/instrument"
	pool "github.com/m3db/m3/src/x/pool"
	retry "github.com/m3db/m3/src/x/retry"
	sampler "github.com/m3db/m3/src/x/sampler"
	serialize "github.com/m3db/m3/src/x/serialize"
...
func (m *MockSession) Fetch(namespace, id ident.ID, startInclusive, endExclusive time.UnixNano) (encoding.SeriesIterator, error) {
	m.ctrl.T.Helper()
...
func (m *MockSession) FetchIDs(namespace ident.ID, ids ident.Iterator, startInclusive, endExclusive time.UnixNano) (encoding.SeriesIterators, error) {
	m.ctrl.T.Helper()
...
func (m *MockSession) Write(namespace, id ident.ID, t time.UnixNano, value float64, unit time.Unit, annotation []byte) error {
	m.ctrl.T.Helper()
...
func (m *MockSession) WriteTagged(namespace, id ident.ID, tags ident.TagIterator, t time.UnixNano, value float64, unit time.Unit, annotation []byte) error {
	m.ctrl.T.Helper()
...
// Fetch mocks base method.
func (m *MockAdminSession) Fetch(namespace, id ident.ID, startInclusive, endExclusive time.UnixNano) (encoding.SeriesIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Fetch", namespace, id, startInclusive, endExclusive)
	ret0, _ := ret[0].(encoding.SeriesIterator)
	ret1, _ := ret[1].(error)
...
func (m *MockAdminSession) FetchBlocksMetadataFromPeers(namespace ident.ID, shard uint32, start, end time.UnixNano, consistencyLevel topology.ReadConsistencyLevel, result result.Options) (PeerBlockMetadataIter, error) {
	m.ctrl.T.Helper()
...
func (m *MockAdminSession) FetchBootstrapBlocksFromPeers(namespace namespace.Metadata, shard uint32, start, end time.UnixNano, opts result.Options) (result.ShardResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockAdminSession) FetchBootstrapBlocksMetadataFromPeers(namespace ident.ID, shard uint32, start, end time.UnixNano, result result.Options) (PeerBlockMetadataIter, error) {
	m.ctrl.T.Helper()
...
// FetchIDs mocks base method.
func (m *MockAdminSession) FetchIDs(namespace ident.ID, ids ident.Iterator, startInclusive, endExclusive time.UnixNano) (encoding.SeriesIterators, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchIDs", namespace, ids, startInclusive, endExclusive)
	ret0, _ := ret[0].(encoding.SeriesIterators)
	ret1, _ := ret[1].(error)
...
// Write mocks base method.
func (m *MockAdminSession) Write(namespace, id ident.ID, t time.UnixNano, value float64, unit time.Unit, annotation []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Write", namespace, id, t, value, unit, annotation)
	ret0, _ := ret[0].(error)
	return ret0
...
// WriteTagged mocks base method.
func (m *MockAdminSession) WriteTagged(namespace, id ident.ID, tags ident.TagIterator, t time.UnixNano, value float64, unit time.Unit, annotation []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteTagged", namespace, id, tags, t, value, unit, annotation)
	ret0, _ := ret[0].(error)
	return ret0
...
func (m *MockOptions) BackgroundConnectInterval() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) BackgroundConnectStutter() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) BackgroundHealthCheckInterval() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) BackgroundHealthCheckStutter() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) ClusterConnectTimeout() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) FetchRequestTimeout() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) HostConnectTimeout() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) HostQueueOpsFlushInterval() time0.Duration {
	m.ctrl.T.Helper()
...
// MiddlewareCircuitbreakerConfig mocks base method.
func (m *MockOptions) MiddlewareCircuitbreakerConfig() middleware.Config {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MiddlewareCircuitbreakerConfig")
	ret0, _ := ret[0].(middleware.Config)
	return ret0
}

// MiddlewareCircuitbreakerConfig indicates an expected call of MiddlewareCircuitbreakerConfig.
func (mr *MockOptionsMockRecorder) MiddlewareCircuitbreakerConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockOptions) SetBackgroundConnectInterval(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetBackgroundConnectStutter(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetBackgroundHealthCheckInterval(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetBackgroundHealthCheckStutter(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetClusterConnectTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetFetchRequestTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetHostConnectTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetHostQueueOpsFlushInterval(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
// SetMiddlewareCircuitbreakerConfig mocks base method.
func (m *MockOptions) SetMiddlewareCircuitbreakerConfig(cfg middleware.Config) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetMiddlewareCircuitbreakerConfig", cfg)
	ret0, _ := ret[0].(Options)
	return ret0
}

// SetMiddlewareCircuitbreakerConfig indicates an expected call of SetMiddlewareCircuitbreakerConfig.
...
// SetShardsLeavingAndInitializingCountTowardsConsistency mocks base method.
func (m *MockOptions) SetShardsLeavingAndInitializingCountTowardsConsistency(value bool) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetShardsLeavingAndInitializingCountTowardsConsistency", value)
	ret0, _ := ret[0].(Options)
	return ret0
}

// SetShardsLeavingAndInitializingCountTowardsConsistency indicates an expected call of SetShardsLeavingAndInitializingCountTowardsConsistency.
func (mr *MockOptionsMockRecorder) SetShardsLeavingAndInitializingCountTowardsConsistency(value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetShardsLeavingAndInitializingCountTowardsConsistency", reflect.TypeOf((*MockOptions)(nil).SetShardsLeavingAndInitializingCountTowardsConsistency), value)
}
...
func (m *MockOptions) SetTruncateRequestTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetWriteRequestTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetWriteTimestampOffset(value time0.Duration) AdminOptions {
	m.ctrl.T.Helper()
...
func (m *MockOptions) TruncateRequestTimeout() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) WriteRequestTimeout() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockOptions) WriteTimestampOffset() time0.Duration {
	m.ctrl.T.Helper()
...
// BackgroundConnectInterval mocks base method.
func (m *MockAdminOptions) BackgroundConnectInterval() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BackgroundConnectInterval")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// BackgroundConnectStutter mocks base method.
func (m *MockAdminOptions) BackgroundConnectStutter() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BackgroundConnectStutter")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// BackgroundHealthCheckInterval mocks base method.
func (m *MockAdminOptions) BackgroundHealthCheckInterval() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BackgroundHealthCheckInterval")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// BackgroundHealthCheckStutter mocks base method.
func (m *MockAdminOptions) BackgroundHealthCheckStutter() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BackgroundHealthCheckStutter")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// ClusterConnectTimeout mocks base method.
func (m *MockAdminOptions) ClusterConnectTimeout() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClusterConnectTimeout")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// FetchRequestTimeout mocks base method.
func (m *MockAdminOptions) FetchRequestTimeout() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchRequestTimeout")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
func (m *MockAdminOptions) FetchSeriesBlocksBatchTimeout() time0.Duration {
	m.ctrl.T.Helper()
...
func (m *MockAdminOptions) FetchSeriesBlocksMetadataBatchTimeout() time0.Duration {
	m.ctrl.T.Helper()
...
// HostConnectTimeout mocks base method.
func (m *MockAdminOptions) HostConnectTimeout() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HostConnectTimeout")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// HostQueueOpsFlushInterval mocks base method.
func (m *MockAdminOptions) HostQueueOpsFlushInterval() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HostQueueOpsFlushInterval")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// MiddlewareCircuitbreakerConfig mocks base method.
func (m *MockAdminOptions) MiddlewareCircuitbreakerConfig() middleware.Config {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MiddlewareCircuitbreakerConfig")
	ret0, _ := ret[0].(middleware.Config)
	return ret0
...
// MiddlewareCircuitbreakerConfig indicates an expected call of MiddlewareCircuitbreakerConfig.
func (mr *MockAdminOptionsMockRecorder) MiddlewareCircuitbreakerConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetBackgroundConnectInterval mocks base method.
func (m *MockAdminOptions) SetBackgroundConnectInterval(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetBackgroundConnectInterval", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetBackgroundConnectStutter mocks base method.
func (m *MockAdminOptions) SetBackgroundConnectStutter(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetBackgroundConnectStutter", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetBackgroundHealthCheckInterval mocks base method.
func (m *MockAdminOptions) SetBackgroundHealthCheckInterval(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetBackgroundHealthCheckInterval", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetBackgroundHealthCheckStutter mocks base method.
func (m *MockAdminOptions) SetBackgroundHealthCheckStutter(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetBackgroundHealthCheckStutter", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetClusterConnectTimeout mocks base method.
func (m *MockAdminOptions) SetClusterConnectTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetClusterConnectTimeout", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetFetchRequestTimeout mocks base method.
func (m *MockAdminOptions) SetFetchRequestTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetFetchRequestTimeout", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
func (m *MockAdminOptions) SetFetchSeriesBlocksBatchTimeout(value time0.Duration) AdminOptions {
	m.ctrl.T.Helper()
...
func (m *MockAdminOptions) SetFetchSeriesBlocksMetadataBatchTimeout(value time0.Duration) AdminOptions {
	m.ctrl.T.Helper()
...
// SetHostConnectTimeout mocks base method.
func (m *MockAdminOptions) SetHostConnectTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetHostConnectTimeout", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetHostQueueOpsFlushInterval mocks base method.
func (m *MockAdminOptions) SetHostQueueOpsFlushInterval(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetHostQueueOpsFlushInterval", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetMiddlewareCircuitbreakerConfig mocks base method.
func (m *MockAdminOptions) SetMiddlewareCircuitbreakerConfig(cfg middleware.Config) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetMiddlewareCircuitbreakerConfig", cfg)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetShardsLeavingAndInitializingCountTowardsConsistency mocks base method.
func (m *MockAdminOptions) SetShardsLeavingAndInitializingCountTowardsConsistency(value bool) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetShardsLeavingAndInitializingCountTowardsConsistency", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetShardsLeavingAndInitializingCountTowardsConsistency indicates an expected call of SetShardsLeavingAndInitializingCountTowardsConsistency.
func (mr *MockAdminOptionsMockRecorder) SetShardsLeavingAndInitializingCountTowardsConsistency(value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetShardsLeavingAndInitializingCountTowardsConsistency", reflect.TypeOf((*MockAdminOptions)(nil).SetShardsLeavingAndInitializingCountTowardsConsistency), value)
}
...
// SetTruncateRequestTimeout mocks base method.
func (m *MockAdminOptions) SetTruncateRequestTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetTruncateRequestTimeout", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetWriteRequestTimeout mocks base method.
func (m *MockAdminOptions) SetWriteRequestTimeout(value time0.Duration) Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetWriteRequestTimeout", value)
	ret0, _ := ret[0].(Options)
	return ret0
...
// SetWriteTimestampOffset mocks base method.
func (m *MockAdminOptions) SetWriteTimestampOffset(value time0.Duration) AdminOptions {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetWriteTimestampOffset", value)
	ret0, _ := ret[0].(AdminOptions)
	return ret0
...
// TruncateRequestTimeout mocks base method.
func (m *MockAdminOptions) TruncateRequestTimeout() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TruncateRequestTimeout")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// WriteRequestTimeout mocks base method.
func (m *MockAdminOptions) WriteRequestTimeout() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteRequestTimeout")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// WriteTimestampOffset mocks base method.
func (m *MockAdminOptions) WriteTimestampOffset() time0.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteTimestampOffset")
	ret0, _ := ret[0].(time0.Duration)
	return ret0
...
// Fetch mocks base method.
func (m *MockclientSession) Fetch(namespace, id ident.ID, startInclusive, endExclusive time.UnixNano) (encoding.SeriesIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Fetch", namespace, id, startInclusive, endExclusive)
	ret0, _ := ret[0].(encoding.SeriesIterator)
	ret1, _ := ret[1].(error)
...
// FetchBlocksMetadataFromPeers mocks base method.
func (m *MockclientSession) FetchBlocksMetadataFromPeers(namespace ident.ID, shard uint32, start, end time.UnixNano, consistencyLevel topology.ReadConsistencyLevel, result result.Options) (PeerBlockMetadataIter, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchBlocksMetadataFromPeers", namespace, shard, start, end, consistencyLevel, result)
	ret0, _ := ret[0].(PeerBlockMetadataIter)
	ret1, _ := ret[1].(error)
...
// FetchBootstrapBlocksFromPeers mocks base method.
func (m *MockclientSession) FetchBootstrapBlocksFromPeers(namespace namespace.Metadata, shard uint32, start, end time.UnixNano, opts result.Options) (result.ShardResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchBootstrapBlocksFromPeers", namespace, shard, start, end, opts)
	ret0, _ := ret[0].(result.ShardResult)
	ret1, _ := ret[1].(error)
...
// FetchBootstrapBlocksMetadataFromPeers mocks base method.
func (m *MockclientSession) FetchBootstrapBlocksMetadataFromPeers(namespace ident.ID, shard uint32, start, end time.UnixNano, result result.Options) (PeerBlockMetadataIter, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchBootstrapBlocksMetadataFromPeers", namespace, shard, start, end, result)
	ret0, _ := ret[0].(PeerBlockMetadataIter)
	ret1, _ := ret[1].(error)
...
// FetchIDs mocks base method.
func (m *MockclientSession) FetchIDs(namespace ident.ID, ids ident.Iterator, startInclusive, endExclusive time.UnixNano) (encoding.SeriesIterators, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchIDs", namespace, ids, startInclusive, endExclusive)
	ret0, _ := ret[0].(encoding.SeriesIterators)
	ret1, _ := ret[1].(error)
...
// Write mocks base method.
func (m *MockclientSession) Write(namespace, id ident.ID, t time.UnixNano, value float64, unit time.Unit, annotation []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Write", namespace, id, t, value, unit, annotation)
	ret0, _ := ret[0].(error)
	return ret0
...
// WriteTagged mocks base method.
func (m *MockclientSession) WriteTagged(namespace, id ident.ID, tags ident.TagIterator, t time.UnixNano, value float64, unit time.Unit, annotation []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteTagged", namespace, id, tags, t, value, unit, annotation)
	ret0, _ := ret[0].(error)
	return ret0
