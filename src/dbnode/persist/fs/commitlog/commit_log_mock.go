...
// Source: /Users/richardartoul/gocode/src/github.com/m3db/m3db/src/dbnode/persist/fs/commitlog/types.go
...
import (
	...
	fs "github.com/m3db/m3db/src/dbnode/persist/fs"
...
func (m *MockCommitLog) Write(ctx context.Context, series Series, datapoint ts.Datapoint, unit time.Unit, annotation ts.Annotation) error {
...
func (m *MockIterator) Current() (Series, ts.Datapoint, time.Unit, ts.Annotation) {
...
func (m *MockOptions) SetRetentionPeriod(value time0.Duration) Options {
...
func (m *MockOptions) RetentionPeriod() time0.Duration {
...
func (m *MockOptions) SetBlockSize(value time0.Duration) Options {
...
func (m *MockOptions) BlockSize() time0.Duration {
...
func (m *MockOptions) SetFlushInterval(value time0.Duration) Options {
...
func (m *MockOptions) FlushInterval() time0.Duration {
