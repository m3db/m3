...
// Source: /Users/r/go/src/github.com/m3db/m3/src/dbnode/encoding/types.go
...
func (m *MockEncoder) Encode(dp ts.Datapoint, unit time.Unit, annotation ts.Annotation) error {
	m.ctrl.T.Helper()
...
func (m *MockEncoder) Reset(t time0.Time, capacity int, schema namespace.SchemaDescr) {
	m.ctrl.T.Helper()
...
func (m *MockEncoder) DiscardReset(t time0.Time, capacity int, schema namespace.SchemaDescr) ts.Segment {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetDefaultTimeUnit(tu time.Unit) Options {
	m.ctrl.T.Helper()
...
func (m *MockOptions) DefaultTimeUnit() time.Unit {
	m.ctrl.T.Helper()
...
func (m *MockOptions) SetTimeEncodingSchemes(value map[time.Unit]TimeEncodingScheme) Options {
	m.ctrl.T.Helper()
...
// Current mocks base method
func (m *MockReaderIterator) Current() (ts.Datapoint, time.Unit, ts.Annotation) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Current")
	ret0, _ := ret[0].(ts.Datapoint)
	ret1, _ := ret[1].(time.Unit)
...
// Reset mocks base method
func (m *MockMultiReaderIterator) Reset(readers []xio.SegmentReader, start time0.Time, blockSize time0.Duration, schema namespace.SchemaDescr) {
	m.ctrl.T.Helper()
...
// Current mocks base method
func (m *MockSeriesIteratorAccumulator) Current() (ts.Datapoint, time.Unit, ts.Annotation) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Current")
	ret0, _ := ret[0].(ts.Datapoint)
	ret1, _ := ret[1].(time.Unit)
...
func (m *MockSeriesIteratorAccumulator) Start() time0.Time {
	m.ctrl.T.Helper()
...
func (m *MockSeriesIteratorAccumulator) End() time0.Time {
	m.ctrl.T.Helper()
...
// Start mocks base method
func (m *MockSeriesIterator) Start() time0.Time {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Start")
	ret0, _ := ret[0].(time0.Time)
	return ret0
...
// End mocks base method
func (m *MockSeriesIterator) End() time0.Time {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "End")
	ret0, _ := ret[0].(time0.Time)
	return ret0
