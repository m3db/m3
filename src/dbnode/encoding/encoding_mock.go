...
// Source: /Users/richardartoul/gocode/src/github.com/m3db/m3db/src/dbnode/encoding/types.go
...
import (
	...
	xpool "github.com/m3db/m3db/src/dbnode/x/xpool"
...
func (m *MockEncoder) Reset(t time0.Time, capacity int) {
...
func (m *MockEncoder) DiscardReset(t time0.Time, capacity int) ts.Segment {
...
// Reset mocks base method
func (m *MockMultiReaderIterator) Reset(readers []xio.SegmentReader, start time0.Time, blockSize time0.Duration) {
...
// Reset mocks base method
func (m *MockSeriesIterator) Reset(id, ns ident.ID, t ident.TagIterator, startInclusive, endExclusive time0.Time, replicas []MultiReaderIterator) {
