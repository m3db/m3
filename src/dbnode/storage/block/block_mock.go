...
// Source: /Users/richardartoul/gocode/src/github.com/m3db/m3db/src/dbnode/storage/block/types.go
...
import (
	...
	ts "github.com/m3db/m3db/src/dbnode/ts"
...
func (m *MockDatabaseBlock) OnRetrieveBlock(id ident.ID, tags ident.TagIterator, startTime time0.Time, segment ts.Segment) {
...
func (m *MockDatabaseBlock) StartTime() time0.Time {
...
func (m *MockDatabaseBlock) BlockSize() time0.Duration {
...
func (m *MockDatabaseBlock) SetLastReadTime(value time0.Time) {
...
func (m *MockDatabaseBlock) LastReadTime() time0.Time {
...
// Reset mocks base method
func (m *MockDatabaseBlock) Reset(startTime time0.Time, blockSize time0.Duration, segment ts.Segment) {
...
func (m *MockDatabaseBlock) ResetRetrievable(startTime time0.Time, blockSize time0.Duration, retriever DatabaseShardBlockRetriever, metadata RetrievableBlockMetadata) {
...
// OnEvictedFromWiredList mocks base method
func (m *MockOnEvictedFromWiredList) OnEvictedFromWiredList(id ident.ID, blockStart time0.Time) {
...
// OnRetrieveBlock mocks base method
func (m *MockOnRetrieveBlock) OnRetrieveBlock(id ident.ID, tags ident.TagIterator, startTime time0.Time, segment ts.Segment) {
	m.ctrl.Call(m, "OnRetrieveBlock", id, tags, startTime, segment)
}
...
// Stream mocks base method
func (m *MockDatabaseBlockRetriever) Stream(ctx context.Context, shard uint32, id ident.ID, blockStart time0.Time, onRetrieve OnRetrieveBlock) (xio.BlockReader, error) {
...
// Stream mocks base method
func (m *MockDatabaseShardBlockRetriever) Stream(ctx context.Context, id ident.ID, blockStart time0.Time, onRetrieve OnRetrieveBlock) (xio.BlockReader, error) {
...
func (m *MockDatabaseSeriesBlocks) MinTime() time0.Time {
...
func (m *MockDatabaseSeriesBlocks) MaxTime() time0.Time {
...
func (m *MockDatabaseSeriesBlocks) BlockAt(t time0.Time) (DatabaseBlock, bool) {
...
func (m *MockDatabaseSeriesBlocks) AllBlocks() map[time.UnixNano]DatabaseBlock {
...
func (m *MockDatabaseSeriesBlocks) RemoveBlockAt(t time0.Time) {
