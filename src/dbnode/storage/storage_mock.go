...
// Source: /Users/haijuncao/gocode/src/github.com/m3db/m3/src/dbnode/storage/types.go
...
func (m *MockdatabaseNamespace) Tick(c context.Cancellable, tickStart time0.Time) error {
	m.ctrl.T.Helper()
...
// Write mocks base method
func (m *MockdatabaseNamespace) Write(ctx context.Context, id ident.ID, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) (ts.Series, bool, error) {
	m.ctrl.T.Helper()
...
// WriteTagged mocks base method
func (m *MockdatabaseNamespace) WriteTagged(ctx context.Context, id ident.ID, tags ident.TagIterator, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) (ts.Series, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockdatabaseNamespace) Flush(blockStart time0.Time, ShardBootstrapStates ShardBootstrapStates, flush persist.FlushPreparer) error {
	m.ctrl.T.Helper()
...
func (m *MockdatabaseNamespace) IsCapturedBySnapshot(alignedInclusiveStart, alignedInclusiveEnd, t time0.Time) (bool, error) {
	m.ctrl.T.Helper()
...
// Tick mocks base method
func (m *MockdatabaseShard) Tick(c context.Cancellable, tickStart time0.Time, nsCtx namespace.Context) (tickResult, error) {
	m.ctrl.T.Helper()
...
// Write mocks base method
func (m *MockdatabaseShard) Write(ctx context.Context, id ident.ID, timestamp time0.Time, value float64, unit time.Unit, annotation []byte, wOpts series.WriteOptions) (ts.Series, bool, error) {
	m.ctrl.T.Helper()
...
// WriteTagged mocks base method
func (m *MockdatabaseShard) WriteTagged(ctx context.Context, id ident.ID, tags ident.TagIterator, timestamp time0.Time, value float64, unit time.Unit, annotation []byte, wOpts series.WriteOptions) (ts.Series, bool, error) {
	m.ctrl.T.Helper()
...
// Flush mocks base method
func (m *MockdatabaseShard) Flush(blockStart time0.Time, flush persist.FlushPreparer, nsCtx namespace.Context) error {
	m.ctrl.T.Helper()
...
// Tick mocks base method
func (m *MocknamespaceIndex) Tick(c context.Cancellable, tickStart time0.Time) (namespaceIndexTickResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Tick", c, tickStart)
...
// Tick mocks base method
func (m *MockdatabaseTickManager) Tick(forceType forceType, tickStart time0.Time) error {
	m.ctrl.T.Helper()
