...
func hello(ctx *querycontext.Context) (string, error)         { return "hello", nil }
func noArgs(ctx *querycontext.Context) (ts.SeriesList, error) { return ts.SeriesList{}, nil }
func defaultArgs(ctx *querycontext.Context, b bool, f1, f2 float64, s string) (ts.SeriesList, error) {
