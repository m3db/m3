...
replace go.etcd.io/etcd/api/v3 => go.etcd.io/etcd/api/v3 v3.6.0-alpha.0

replace go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.6.0-alpha.0

replace go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.6.0-alpha.0

replace go.etcd.io/etcd/server/v3 => go.etcd.io/etcd/server/v3 v3.6.0-alpha.0
