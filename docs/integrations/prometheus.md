...
Also, if you want to see metrics generated by the coordinator/query process such as number of queries, etc., you should add the following job under `scrape_configs`:
