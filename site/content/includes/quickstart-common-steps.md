...
-   _[{{% apiendpoint %}}prom/remote/write](/docs/components/m3coordinator/api/remote/)_ - Write a Prometheus remote write query to M3DB with a binary snappy compressed Prometheus WriteRequest protobuf message.
