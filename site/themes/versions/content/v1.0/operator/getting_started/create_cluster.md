...
Once you've [installed](/v1.0/docs/operator/getting_started/installation) the M3DB operator and read over the [requirements](/v1.0/docs/operator/getting_started/requirements), you can start
...
pod's UID will be used for its [identity][pod-identity]. The cluster will have 1 [namespace](/v1.0/docs/operator/configuration/namespaces) that stores
