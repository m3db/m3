...
Data eviction from memory is triggered by the "ticking" process described in the [background processes section](/v1.0/docs/m3db/architecture/engine#background-processes)
