...
func (_m *MockdatabaseNamespace) NeedsFlush(start time.Time, end time.Time) bool {
...
func (_m *MockdatabaseFlushManager) NeedsFlush(startInclusive time.Time, endInclusive time.Time) bool {
